...
CVCUDA_DEFINE_API(0, 2, NVCVStatus, cvcudaCompositeSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle fg, NVCVTensorHandle bg,
...
CVCUDA_DEFINE_API(0, 2, NVCVStatus, cvcudaCompositeVarShapeSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, NVCVImageBatchHandle fg, NVCVImageBatchHandle bg,
