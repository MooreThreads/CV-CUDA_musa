...
CVCUDA_DEFINE_API(0, 4, NVCVStatus, cvcudaInpaintSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in, NVCVTensorHandle masks,
...
CVCUDA_DEFINE_API(0, 4, NVCVStatus, cvcudaInpaintVarShapeSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, NVCVImageBatchHandle in, NVCVImageBatchHandle masks,
