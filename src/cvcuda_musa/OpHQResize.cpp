...
CVCUDA_DEFINE_API(0, 6, NVCVStatus, cvcudaHQResizeSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, const NVCVWorkspace *ws, NVCVTensorHandle in,
...
CVCUDA_DEFINE_API(0, 6, NVCVStatus, cvcudaHQResizeImageBatchSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, const NVCVWorkspace *ws, NVCVImageBatchHandle in,
...
CVCUDA_DEFINE_API(0, 6, NVCVStatus, cvcudaHQResizeTensorBatchSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, const NVCVWorkspace *ws, NVCVTensorBatchHandle in,
