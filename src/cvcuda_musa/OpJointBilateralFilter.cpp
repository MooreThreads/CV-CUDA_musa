...
CVCUDA_DEFINE_API(0, 2, NVCVStatus, cvcudaJointBilateralFilterSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in, NVCVTensorHandle inColor,
...
CVCUDA_DEFINE_API(0, 2, NVCVStatus, cvcudaJointBilateralFilterVarShapeSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, NVCVImageBatchHandle in,
