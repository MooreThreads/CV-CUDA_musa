...
CVCUDA_DEFINE_API(0, 5, NVCVStatus, cvcudaFindHomographySubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle srcPts, NVCVTensorHandle dstPts,
...
CVCUDA_DEFINE_API(0, 5, NVCVStatus, cvcudaFindHomographyVarShapeSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorBatchHandle srcPts,
