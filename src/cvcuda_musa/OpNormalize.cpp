...
CVCUDA_DEFINE_API(0, 2, NVCVStatus, cvcudaNormalizeSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in, NVCVTensorHandle base,
...
CVCUDA_DEFINE_API(0, 2, NVCVStatus, cvcudaNormalizeVarShapeSubmit,
                  (NVCVOperatorHandle handle, musaStream_t stream, NVCVImageBatchHandle in, NVCVTensorHandle base,
