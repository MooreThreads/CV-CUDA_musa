 ...
 */
class CudaStream : public UniqueHandle<musaStream_t, CudaStream>
{
public:
    NVCV_INHERIT_UNIQUE_HANDLE(musaStream_t, CudaStream)
    ...
    static void DestroyHandle(musaStream_t stream);
};
