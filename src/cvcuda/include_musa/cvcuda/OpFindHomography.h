 ...
 */
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaFindHomographySubmit(NVCVOperatorHandle handle, musaStream_t stream,
 ...
 *
 */
CVCUDA_PUBLIC NVCVStatus cvcudaFindHomographyVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
