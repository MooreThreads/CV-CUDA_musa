...
inline void Gaussian::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void Gaussian::operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::ImageBatch &out,
                                 const nvcv::Tensor &kernelSize, const nvcv::Tensor &sigma, NVCVBorderType borderMode)
{
