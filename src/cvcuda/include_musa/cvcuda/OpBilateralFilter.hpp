...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, int diameter,
...
inline void BilateralFilter::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void BilateralFilter::operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::ImageBatch &out,
                                        const nvcv::Tensor &diameterData, const nvcv::Tensor &sigmaColorData,
