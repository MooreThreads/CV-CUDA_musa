 ...
 * @retval #NVCV_SUCCESS                Operation executed successfully.
 */
CVCUDA_PUBLIC NVCVStatus cvcudaBilateralFilterSubmit(NVCVOperatorHandle handle, musaStream_t stream,
                                                     NVCVTensorHandle in, NVCVTensorHandle out, int diameter,
                                                     float sigmaColor, float sigmaSpace, NVCVBorderType borderMode);

CVCUDA_PUBLIC NVCVStatus cvcudaBilateralFilterVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
