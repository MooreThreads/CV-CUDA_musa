...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const NVCVRectI cropRect);
...
inline void CustomCrop::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
