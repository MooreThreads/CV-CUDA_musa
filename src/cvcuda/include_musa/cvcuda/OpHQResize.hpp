...
public:
    ...
    void operator()(musaStream_t stream, const Workspace &ws, const nvcv::Tensor &in, const nvcv::Tensor &out,
    ...
    void operator()(musaStream_t stream, const Workspace &ws, const nvcv::ImageBatch &in, const nvcv::ImageBatch &out,
                    const NVCVInterpolationType minInterpolation, const NVCVInterpolationType magInterpolation,
                    bool antialias = false, const HQResizeRoisF roi = {});

    void operator()(musaStream_t stream, const Workspace &ws, const nvcv::TensorBatch &in, const nvcv::TensorBatch &out,
                    const NVCVInterpolationType minInterpolation, const NVCVInterpolationType magInterpolation,
                    bool antialias = false, const HQResizeRoisF roi = {});
...
inline void HQResize::operator()(musaStream_t stream, const Workspace &ws, const nvcv::Tensor &in,
...
inline void HQResize::operator()(musaStream_t stream, const Workspace &ws, const nvcv::ImageBatch &in,
...
inline void HQResize::operator()(musaStream_t stream, const Workspace &ws, const nvcv::TensorBatch &in,
