...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const NVCVSize2D resizeDim,
...
inline void ResizeCropConvertReformat::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void ResizeCropConvertReformat::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
