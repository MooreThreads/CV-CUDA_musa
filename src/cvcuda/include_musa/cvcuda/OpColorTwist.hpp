...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const nvcv::Tensor &twist);
...
inline void ColorTwist::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
                                   const nvcv::Tensor &twist)
{
    nvcv::detail::CheckThrow(cvcudaColorTwistSubmit(m_handle, stream, in.handle(), out.handle(), twist.handle()));
}

inline void ColorTwist::operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::ImageBatch &out,
                                   const nvcv::Tensor &twist)
{
