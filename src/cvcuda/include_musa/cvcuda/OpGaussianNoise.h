...
CVCUDA_PUBLIC NVCVStatus cvcudaGaussianNoiseSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
                                                   NVCVTensorHandle out, NVCVTensorHandle mu, NVCVTensorHandle sigma,
                                                   int8_t per_channel, unsigned long long seed);

CVCUDA_PUBLIC NVCVStatus cvcudaGaussianNoiseVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
