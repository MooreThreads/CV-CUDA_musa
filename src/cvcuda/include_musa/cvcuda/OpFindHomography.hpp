...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &src, const nvcv::Tensor &dst, const nvcv::Tensor &models);

    void operator()(musaStream_t stream, const nvcv::TensorBatch &src, const nvcv::TensorBatch &dst,
...
inline void FindHomography::operator()(musaStream_t stream, const nvcv::Tensor &src, const nvcv::Tensor &dst,
...
inline void FindHomography::operator()(musaStream_t stream, const nvcv::TensorBatch &src, const nvcv::TensorBatch &dst,
                                       const nvcv::TensorBatch &models)
{
