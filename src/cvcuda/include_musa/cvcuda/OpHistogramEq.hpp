...
inline void HistogramEq::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out)
{
    nvcv::detail::CheckThrow(cvcudaHistogramEqSubmit(m_handle, stream, in.handle(), out.handle()));
}

inline void HistogramEq::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
