...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, double maxValue,
...
inline void AdaptiveThreshold::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void AdaptiveThreshold::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
