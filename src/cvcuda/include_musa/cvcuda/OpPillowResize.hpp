...
public:
    ...
    void operator()(musaStream_t stream, const Workspace &ws, const nvcv::ImageBatchVarShape &in,
...
inline void PillowResize::operator()(musaStream_t stream, const Workspace &ws, const nvcv::Tensor &in,
...
inline void PillowResize::operator()(musaStream_t stream, const Workspace &ws, const nvcv::ImageBatchVarShape &in,
                                     const nvcv::ImageBatchVarShape &out, const NVCVInterpolationType interpolation)
{
