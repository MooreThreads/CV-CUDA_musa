 ...
 * @retval #NVCV_SUCCESS                Operation executed successfully.
 */
CVCUDA_PUBLIC NVCVStatus cvcudaLaplacianSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
 ...
 * @param[in] borderMode Border mode to be used when accessing elements outside input image, cf. \p NVCVBorderType.
 */
CVCUDA_PUBLIC NVCVStatus cvcudaLaplacianVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
