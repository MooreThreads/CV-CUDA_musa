...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const double angleDeg,
...
inline void Rotate::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void Rotate::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
