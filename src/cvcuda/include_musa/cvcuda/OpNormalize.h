 ...
 */
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaNormalizeSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
...
CVCUDA_PUBLIC NVCVStatus cvcudaNormalizeVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
