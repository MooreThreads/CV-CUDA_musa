...
*/
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaEraseSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
...
CVCUDA_PUBLIC NVCVStatus cvcudaEraseVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
