...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const nvcv::Tensor &bgLabel,
...
inline void Label::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
