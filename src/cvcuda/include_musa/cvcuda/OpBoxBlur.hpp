...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const NVCVBlurBoxesI bboxes);
...
inline void BoxBlur::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
