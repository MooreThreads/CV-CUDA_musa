...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const nvcv::Tensor &mu,
...
inline void GaussianNoise::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void GaussianNoise::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
