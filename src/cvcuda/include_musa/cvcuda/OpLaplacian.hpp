...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, int32_t ksize, float scale,
...
inline void Laplacian::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, int32_t ksize,
...
inline void Laplacian::operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::ImageBatch &out,
                                  const nvcv::Tensor &ksize, const nvcv::Tensor &scale, NVCVBorderType borderMode)
{
