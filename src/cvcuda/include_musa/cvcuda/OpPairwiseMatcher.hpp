...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &set1, const nvcv::Tensor &set2,
...
inline void PairwiseMatcher::operator()(musaStream_t stream, const nvcv::Tensor &set1, const nvcv::Tensor &set2,
