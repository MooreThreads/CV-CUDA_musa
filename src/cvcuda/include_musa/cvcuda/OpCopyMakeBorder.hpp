...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, int32_t top, int32_t left,
                    NVCVBorderType borderMode, const float4 borderValue);
    void operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::ImageBatchVarShape &out,
                    const nvcv::Tensor &top, const nvcv::Tensor &left, NVCVBorderType borderMode,
                    const float4 borderValue);
    void operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::Tensor &out,
                    const nvcv::Tensor &top, const nvcv::Tensor &left, NVCVBorderType borderMode,
                    const float4 borderValue);
...
inline void CopyMakeBorder::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void CopyMakeBorder::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
...
inline void CopyMakeBorder::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::Tensor &out,
                                       const nvcv::Tensor &top, const nvcv::Tensor &left, NVCVBorderType borderMode,
                                       const float4 borderValue)
{
