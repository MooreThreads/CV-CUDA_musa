...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &base, const nvcv::Tensor &scale,
                    const nvcv::Tensor &out, float global_scale, float shift, float epsilon, uint32_t flags = 0);

    void operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::Tensor &base,
...
inline void Normalize::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &base,
...
inline void Normalize::operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::Tensor &base,
