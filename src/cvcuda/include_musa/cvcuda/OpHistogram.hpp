...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, nvcv::OptionalTensorConstRef mask,
...
inline void Histogram::operator()(musaStream_t stream, const nvcv::Tensor &in, nvcv::OptionalTensorConstRef mask,
                                  const nvcv::Tensor &histogram)
{
