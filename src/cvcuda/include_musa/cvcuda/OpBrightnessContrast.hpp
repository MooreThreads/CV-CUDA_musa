...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void BrightnessContrast::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void BrightnessContrast::operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::ImageBatch &out,
                                           const nvcv::Tensor &brightness, const nvcv::Tensor &contrast,
                                           const nvcv::Tensor &brightnessShift, const nvcv::Tensor &contrastCenter)
{
