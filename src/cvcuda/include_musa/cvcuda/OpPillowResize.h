 ...
 */
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaPillowResizeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
                                                  const NVCVWorkspace *workspace, NVCVTensorHandle in,
                                                  NVCVTensorHandle out, NVCVInterpolationType interpolation);

CVCUDA_PUBLIC NVCVStatus cvcudaPillowResizeVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
