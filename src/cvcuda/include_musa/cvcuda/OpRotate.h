 ...
 */
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaRotateSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
                                            NVCVTensorHandle out, const double angleDeg, const double2 shift,
                                            const NVCVInterpolationType interpolation);

CVCUDA_PUBLIC NVCVStatus cvcudaRotateVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
