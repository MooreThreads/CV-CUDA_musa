...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::TensorBatch &in, const nvcv::Tensor &out);
...
inline void Stack::operator()(musaStream_t stream, const nvcv::TensorBatch &in, const nvcv::Tensor &out)
{
