 ...
 * @retval #NVCV_SUCCESS                Operation executed successfully.
 */
CVCUDA_PUBLIC NVCVStatus cvcudaMinMaxLocSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
 ...
 */
CVCUDA_PUBLIC NVCVStatus cvcudaMinMaxLocVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
