...
inline void CvtColor::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
                                 NVCVColorConversionCode code)
{
    nvcv::detail::CheckThrow(cvcudaCvtColorSubmit(m_handle, stream, in.handle(), out.handle(), code));
}

inline void CvtColor::operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::ImageBatch &out,
                                 NVCVColorConversionCode code)
{
