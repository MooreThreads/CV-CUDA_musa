...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const NVCVBndBoxesI bboxes);
...
inline void BndBox::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
