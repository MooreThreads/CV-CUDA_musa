 ...
 *
 * @code
 * using BaseType = typename nvcv::musa::TypeTraits<T>::base_type;
 * int nc = nvcv::musa::TypeTraits<T>::components;
 * int ne = nvcv::musa::TypeTraits<T>::elements;
 * const char *name = nvcv::musa::TypeTraits<T>::name;
 * T min = nvcv::musa::TypeTraits<T>::min;
 * T max = nvcv::musa::TypeTraits<T>::max;
 * @endcode
 *
 ...
 * @code
 * using DataType = ...;
 * using ChannelType = nvcv::musa::BaseType<DataType>;
 * @endcode
 *
 ...
 * @code
 * using DataType = ...;
 * int nc = nvcv::musa::NumComponents<DataType>;
 * @endcode
 *
 ...
 * @code
 * using DataType = ...;
 * for (int e = 0; e < nvcv::musa::NumElements<DataType>; ++e)
 *     // ...
 * @endcode
 *
