...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &foreground, const nvcv::Tensor &background,
                    const nvcv::Tensor &fgMask, const nvcv::Tensor &output);

    void operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &foreground,
...
inline void Composite::operator()(musaStream_t stream, const nvcv::Tensor &foreground, const nvcv::Tensor &background,
                                  const nvcv::Tensor &fgMask, const nvcv::Tensor &output)
{
...
inline void Composite::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &foreground,
                                  const nvcv::ImageBatchVarShape &background, const nvcv::ImageBatchVarShape &fgMask,
                                  const nvcv::ImageBatchVarShape &output)
{
