...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &minVal, const nvcv::Tensor &minLoc,
                    const nvcv::Tensor &numMin, const nvcv::Tensor &maxVal, const nvcv::Tensor &maxLoc,
                    const nvcv::Tensor &numMax) const;

    void operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::Tensor &minVal,
...
inline void MinMaxLoc::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &minVal,
                                  const nvcv::Tensor &minLoc, const nvcv::Tensor &numMin, const nvcv::Tensor &maxVal,
                                  const nvcv::Tensor &maxLoc, const nvcv::Tensor &numMax) const
{
...
inline void MinMaxLoc::operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::Tensor &minVal,
                                  const nvcv::Tensor &minLoc, const nvcv::Tensor &numMin, const nvcv::Tensor &maxVal,
                                  const nvcv::Tensor &maxLoc, const nvcv::Tensor &numMax) const
{
