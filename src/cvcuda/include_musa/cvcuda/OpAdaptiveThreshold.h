 ...
 * @retval #NVCV_SUCCESS                Operation executed successfully.
 */
CVCUDA_PUBLIC NVCVStatus cvcudaAdaptiveThresholdSubmit(NVCVOperatorHandle handle, musaStream_t stream,
...
CVCUDA_PUBLIC NVCVStatus cvcudaAdaptiveThresholdVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
