...
inline void WarpAffine::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void WarpAffine::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
