 ...
 * @retval #NVCV_SUCCESS                Operation executed successfully.
 */
CVCUDA_PUBLIC NVCVStatus cvcudaBrightnessContrastSubmit(NVCVOperatorHandle handle, musaStream_t stream,
 ...
 */
CVCUDA_PUBLIC NVCVStatus cvcudaBrightnessContrastVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
