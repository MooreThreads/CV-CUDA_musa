...
*/
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaInpaintSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
                                             NVCVTensorHandle masks, NVCVTensorHandle out, double inpaintRadius);

CVCUDA_PUBLIC NVCVStatus cvcudaInpaintVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
