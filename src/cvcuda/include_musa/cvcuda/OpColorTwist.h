 ...
 * @retval #NVCV_SUCCESS                Operation executed successfully.
 */
CVCUDA_PUBLIC NVCVStatus cvcudaColorTwistSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
 ...
 *
 */
CVCUDA_PUBLIC NVCVStatus cvcudaColorTwistVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
