 ...
 */
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaMedianBlurSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
                                                NVCVTensorHandle out, const int32_t kernelWidth,
                                                const int32_t KernelHeight);

CVCUDA_PUBLIC NVCVStatus cvcudaMedianBlurVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
