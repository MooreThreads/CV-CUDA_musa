...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const double alpha,
                    const double beta);
...
inline void ConvertTo::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
