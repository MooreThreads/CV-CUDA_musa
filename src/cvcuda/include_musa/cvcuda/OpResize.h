 ...
 */
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaResizeSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
                                            NVCVTensorHandle out, const NVCVInterpolationType interpolation);

CVCUDA_PUBLIC NVCVStatus cvcudaResizeVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
