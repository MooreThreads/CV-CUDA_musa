...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const nvcv::Tensor &scores,
...
inline void NonMaximumSuppression::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
