...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const nvcv::Tensor &thresh,
...
inline void Threshold::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
                                  const nvcv::Tensor &thresh, const nvcv::Tensor &maxval)
{
...
inline void Threshold::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
