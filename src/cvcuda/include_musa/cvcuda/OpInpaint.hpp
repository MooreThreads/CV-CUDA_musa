...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &masks, const nvcv::Tensor &out,
                    double inpaintRadius);

    void operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::ImageBatchVarShape &masks,
...
inline void Inpaint::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &masks,
...
inline void Inpaint::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
