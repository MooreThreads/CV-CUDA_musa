...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const nvcv::Size2D ksize);
...
inline void MedianBlur::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
inline void MedianBlur::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
