 ...
 */
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaCompositeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
                                               NVCVTensorHandle foreground, NVCVTensorHandle background,
                                               NVCVTensorHandle fgMask, NVCVTensorHandle output);

CVCUDA_PUBLIC NVCVStatus cvcudaCompositeVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
