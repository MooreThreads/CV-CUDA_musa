...
*/
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaThresholdSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
                                               NVCVTensorHandle out, NVCVTensorHandle thresh, NVCVTensorHandle maxval);

CVCUDA_PUBLIC NVCVStatus cvcudaThresholdVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
