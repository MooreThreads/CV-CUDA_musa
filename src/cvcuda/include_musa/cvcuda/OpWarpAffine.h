 ...
 * @retval #NVCV_SUCCESS                Operation executed successfully.
 */
CVCUDA_PUBLIC NVCVStatus cvcudaWarpAffineSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
                                                NVCVTensorHandle out, const NVCVAffineTransform xform,
                                                const int32_t flags, const NVCVBorderType borderMode,
                                                const float4 borderValue);

CVCUDA_PUBLIC NVCVStatus cvcudaWarpAffineVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
