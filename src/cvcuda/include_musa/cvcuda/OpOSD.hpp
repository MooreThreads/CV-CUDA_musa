...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const NVCVElements elements);
...
inline void OSD::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
