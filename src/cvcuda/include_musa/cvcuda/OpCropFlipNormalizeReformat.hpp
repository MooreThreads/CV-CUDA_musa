...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::Tensor &out,
...
inline void CropFlipNormalizeReformat::operator()(musaStream_t stream, const nvcv::ImageBatch &in,
