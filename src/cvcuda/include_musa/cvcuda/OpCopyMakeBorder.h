 ...
 * @retval #NVCV_SUCCESS                Operation executed successfully.
 */
CVCUDA_PUBLIC NVCVStatus cvcudaCopyMakeBorderSubmit(NVCVOperatorHandle handle, musaStream_t stream, NVCVTensorHandle in,
                                                    NVCVTensorHandle out, int32_t top, int32_t left,
                                                    NVCVBorderType borderMode, const float4 borderValue);

CVCUDA_PUBLIC NVCVStatus cvcudaCopyMakeBorderVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
                                                            NVCVImageBatchHandle in, NVCVImageBatchHandle out,
                                                            NVCVTensorHandle top, NVCVTensorHandle left,
                                                            NVCVBorderType borderMode, const float4 borderValue);

CVCUDA_PUBLIC NVCVStatus cvcudaCopyMakeBorderVarShapeStackSubmit(NVCVOperatorHandle handle, musaStream_t stream,
