 ...
 */
/** @{ */
CVCUDA_PUBLIC NVCVStatus cvcudaRandomResizedCropSubmit(NVCVOperatorHandle handle, musaStream_t stream,
                                                       NVCVTensorHandle in, NVCVTensorHandle out,
                                                       const NVCVInterpolationType interpolation);

CVCUDA_PUBLIC NVCVStatus cvcudaRandomResizedCropVarShapeSubmit(NVCVOperatorHandle handle, musaStream_t stream,
