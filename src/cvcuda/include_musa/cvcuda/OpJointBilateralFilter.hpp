...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &inColor, const nvcv::Tensor &out,
                    int diameter, float sigmaColor, float sigmaSpace, NVCVBorderType borderMode);

    void operator()(musaStream_t stream, const nvcv::ImageBatch &in, const nvcv::ImageBatch &inColor,
...
inline void JointBilateralFilter::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &inColor,
...
inline void JointBilateralFilter::operator()(musaStream_t stream, const nvcv::ImageBatch &in,
