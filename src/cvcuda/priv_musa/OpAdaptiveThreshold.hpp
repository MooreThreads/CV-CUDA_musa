...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const double maxValue,
...
private:
    std::unique_ptr<nvcv::legacy::musa_op::AdaptiveThreshold>         m_legacyOp;
    std::unique_ptr<nvcv::legacy::musa_op::AdaptiveThresholdVarShape> m_legacyOpVarShape;
};
