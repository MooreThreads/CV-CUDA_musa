...
void AverageBlur::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
void AverageBlur::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
                             ...
                             const nvcv::Tensor &kernelAnchor, NVCVBorderType borderMode) const
{
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Kernel anchor must be musa-accessible, pitch-linear tensor");
    }
