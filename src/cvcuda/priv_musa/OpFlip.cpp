...
void Flip::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, int32_t flipCode) const
{
...
void Flip::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::ImageBatchVarShape &out,
                      const nvcv::Tensor &flipCode) const
{
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Input must be musa-accessible, varshape pitch-linear "
                              "image batch");
    }
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Output must be musa-accessible, varshape pitch-linear"
                              " image batch");
    }
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Flip Code must be musa-accessible, pitch-linear tensor");
    }
