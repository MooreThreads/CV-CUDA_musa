...
void WarpPerspective::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
void WarpPerspective::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
                                 ...
                                 const int32_t flags, const NVCVBorderType borderMode, const float4 borderValue) const
{
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "transformation matrix must be musa-accessible, pitch-linear tensor");
    }
