...
void CvtColor::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
void CvtColor::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::ImageBatchVarShape &out,
                          NVCVColorConversionCode code) const
{
