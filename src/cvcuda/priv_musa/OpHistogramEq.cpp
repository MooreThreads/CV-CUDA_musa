...
void HistogramEq::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out) const
{
...
void HistogramEq::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
