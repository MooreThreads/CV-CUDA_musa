...
void MinAreaRect::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
                             const nvcv::Tensor &numPointsInContour, const int totalContours) const
{
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "numPointsInContour must be musa-accessible, pitch-linear tensor");
    }
