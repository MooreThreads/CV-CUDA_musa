...
public:
    ...
    virtual void operator()(musaStream_t stream, const Workspace &ws, const nvcv::Tensor &src, const nvcv::Tensor &dst,
    ...
    virtual void operator()(musaStream_t stream, const Workspace &ws, const nvcv::ImageBatchVarShape &src,
    ...
    virtual void operator()(musaStream_t stream, const Workspace &ws, const nvcv::TensorBatch &src,
...
public:
    ...
    void operator()(musaStream_t stream, const Workspace &ws, const nvcv::Tensor &src, const nvcv::Tensor &dst,
                    const NVCVInterpolationType minInterpolation, const NVCVInterpolationType magInterpolation,
                    bool antialias, const HQResizeRoiF *roi) const;

    void operator()(musaStream_t stream, const Workspace &ws, const nvcv::ImageBatchVarShape &src,
                    const nvcv::ImageBatchVarShape &dst, const NVCVInterpolationType minInterpolation,
                    const NVCVInterpolationType magInterpolation, bool antialias, const HQResizeRoisF roi) const;

    void operator()(musaStream_t stream, const Workspace &ws, const nvcv::TensorBatch &src,
                    const nvcv::TensorBatch &dst, const NVCVInterpolationType minInterpolation,
                    const NVCVInterpolationType magInterpolation, bool antialias, const HQResizeRoisF roi) const;
