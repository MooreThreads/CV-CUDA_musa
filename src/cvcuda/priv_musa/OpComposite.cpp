...
void Composite::operator()(musaStream_t stream, const nvcv::Tensor &foreground, const nvcv::Tensor &background,
                           const nvcv::Tensor &fgMask, const nvcv::Tensor &output) const
{
    ...
    if (foregroundData == nullptr)
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Input foreground must be musa-accessible, pitch-linear tensor");
    }
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Input background must be musa-accessible, pitch-linear tensor");
    }
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Input fgMask must be musa-accessible, pitch-linear tensor");
    }
...
void Composite::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &foreground,
                           ...
                           const nvcv::ImageBatchVarShape &output) const
{
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Input foreground must be musa-accessible, varshape image batch");
    }
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Input background must be musa-accessible, varshape image batch");
    }
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Input fgMask must be musa-accessible, varshape image batch");
    }
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Output must be musa-accessible, varshape image batch");
    }
