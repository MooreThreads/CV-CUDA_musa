...
void Normalize::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &base,
...
void Normalize::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::Tensor &base,
