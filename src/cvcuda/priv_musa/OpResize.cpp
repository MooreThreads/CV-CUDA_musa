...
void Resize::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
void Resize::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::ImageBatchVarShape &out,
                        const NVCVInterpolationType interpolation) const
{
