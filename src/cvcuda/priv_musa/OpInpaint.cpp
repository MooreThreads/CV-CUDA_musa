...
void Inpaint::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &masks,
                         const nvcv::Tensor &out, double inpaintRadius) const
{
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Masks must be musa-accessible, pitch-linear tensor");
    }
...
void Inpaint::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::ImageBatchVarShape &masks,
