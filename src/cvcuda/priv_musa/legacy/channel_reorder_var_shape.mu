...
template<typename T>
__global__ void channel_reorder_kernel(const musa::ImageBatchVarShapeWrapNHWC<const T> src,
                                       musa::ImageBatchVarShapeWrapNHWC<T> dst, const musa::Tensor2DWrap<int> orders)
{
...
void reorder(const ImageBatchVarShapeDataStridedCuda &inData, const ImageBatchVarShapeDataStridedCuda &outData,
             const TensorDataStridedCuda &orderData, int numChannels, musaStream_t stream)
{
    ...
    musa::ImageBatchVarShapeWrapNHWC<const T> src_ptr(inData, numChannels);
    musa::ImageBatchVarShapeWrapNHWC<T>       dst_ptr(outData, numChannels);
    musa::Tensor2DWrap<int>                   order_ptr(orderData);
...
ErrorCode ChannelReorderVarShape::infer(const ImageBatchVarShapeDataStridedCuda &inData,
                                        ...
                                        const TensorDataStridedCuda &orderData, musaStream_t stream)
{
    ...
    typedef void (*func_t)(const ImageBatchVarShapeDataStridedCuda &inData,
                           ...
                           int numChannels, musaStream_t stream);
