...
static void cuosd_text_prepare(cuOSDContext_t context, int width, int height, musaStream_t stream)
{
...
static void cuosd_apply(cuOSDContext_t context, int width, int height, cuOSDImageFormat format, musaStream_t stream)
{
...
__global__ void render_elements_kernel(int bx, int by, const TextLocation *text_locations,
                                     ...
                                     bool inplace, int batch, void *_stream)
{
    ...
    musaStream_t stream = (musaStream_t)_stream;
    dim3         blockSize(16, 8);
    ...
    musaError_t code = musaPeekAtLastError();
    if (code != musaSuccess)
    {
                  ...
                  cuOSDImageFormat format, bool inplace, int batch, void *stream)
{
    ...
    checkRuntime(musaPeekAtLastError());
}

static nvcv::legacy::musa_op::ErrorCode cuosd_draw_text(cuOSDContext_t context, int batch_idx, NVCVText text)
{
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_rectangle(cuOSDContext_t context, int batch_idx, int width, int height, NVCVBndBoxI bbox)
{
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_segmentmask(cuOSDContext_t context, int batch_idx, int width, int height,
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_circle(cuOSDContext_t context, int batch_idx, NVCVCircle circle)
{
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_point(cuOSDContext_t context, int batch_idx, NVCVPoint point)
{
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_line(cuOSDContext_t context, int batch_idx, NVCVLine line)
{
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_polyline(cuOSDContext_t context, int batch_idx, const NVCVPolyLine &pl)
{
    if (pl.numPoints < 2)
        return nvcv::legacy::musa_op::ErrorCode::INVALID_PARAMETER;
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_arrow(cuOSDContext_t context, int batch_idx, NVCVArrow arrow)
{
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_rotationbox(cuOSDContext_t context, int batch_idx, NVCVRotatedBox rb)
{
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_clock(cuOSDContext_t context, int batch_idx, NVCVClock clock)
{
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_elements(cuOSDContext_t context, int width, int height, NVCVElementsImpl *ctx)
{
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_bndbox(cuOSDContext_t context, int width, int height, NVCVBndBoxesImpl *bboxes)
{
...
ErrorCode OSD::infer(const nvcv::TensorDataStridedCuda &inData, const nvcv::TensorDataStridedCuda &outData,
                     NVCVElements elements, musaStream_t stream)
{
    ...
    if (ret != nvcv::legacy::musa_op::ErrorCode::SUCCESS)
    {
    ...
    auto src     = nvcv::musa::CreateTensorWrapNHWC<uint8_t>(inData);
    auto dst     = nvcv::musa::CreateTensorWrapNHWC<uint8_t>(outData);
...
ErrorCode OSD::inferBox(const nvcv::TensorDataStridedCuda &inData, const nvcv::TensorDataStridedCuda &outData,
                        NVCVBndBoxesI bboxes, musaStream_t stream)
{
    musa_op::DataFormat input_format  = GetLegacyDataFormat(inData.layout());
    musa_op::DataFormat output_format = GetLegacyDataFormat(outData.layout());
    ...
    auto src     = nvcv::musa::CreateTensorWrapNHWC<uint8_t, int32_t>(inData);
    auto dst     = nvcv::musa::CreateTensorWrapNHWC<uint8_t, int32_t>(outData);
    bool inplace = inData.basePtr() == outData.basePtr();
