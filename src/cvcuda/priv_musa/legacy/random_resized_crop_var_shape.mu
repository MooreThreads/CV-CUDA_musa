                                  ...
                                  const float *scale_x_, const float *scale_y_)
{
    ...
    { //generic copy pixel to pixel
        ...
        const int sx = musa::min(__float2int_rd((dst_x + 0.5f) * scale_x) + left, width - 1);
        const int sy = musa::min(__float2int_rd((dst_y + 0.5f) * scale_y) + top, height - 1);
...
void resize(const ImageBatchVarShapeDataStridedCuda &in, const ImageBatchVarShapeDataStridedCuda &out,
            const NVCVInterpolationType interpolation, musaStream_t stream, float *scale_y, float *scale_x, int *top,
            int *left)
{
    ...
    musa::ImageBatchVarShapeWrap<T> src(in);
    musa::ImageBatchVarShapeWrap<T> dst(out);
                                           ...
                                           const NVCVInterpolationType interpolation, musaStream_t stream)
{
    ...
    typedef void (*func_t)(const ImageBatchVarShapeDataStridedCuda &in, const ImageBatchVarShapeDataStridedCuda &out,
                           const NVCVInterpolationType interpolation, musaStream_t stream, float *scale_y,
