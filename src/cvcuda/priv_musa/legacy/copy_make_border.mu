...
struct copyMakeBorderDispatcher
{
    static nvcv::legacy::musa_op::ErrorCode call(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData,
                          const T &borderValue, const int left, const int top, musaStream_t stream)
    {
        ...
        {
            auto src = musa::CreateBorderWrapNHW<const T, B, int32_t>(inData, borderValue);
...
nvcv::legacy::musa_op::ErrorCode copyMakeBorder(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData, const int top,
                                ...
                                const float4 &borderValue, musaStream_t stream)
{
    ...
    musa_op::DataType data_type = helpers::GetLegacyDataType(inData.dtype());
