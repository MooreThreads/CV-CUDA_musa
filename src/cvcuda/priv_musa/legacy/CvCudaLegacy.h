...
using murandState = murand_device::xorwow_engine;
#endif
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData, const double alpha,
                    const double beta, musaStream_t stream);
};
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData,
                    const TensorDataStridedCuda &numPointsInContour, const int totalContours, musaStream_t stream);
...
public:
    ...
    ErrorCode infer(const ImageBatchVarShapeDataStridedCuda &input, const ImageBatchVarShapeDataStridedCuda &output,
                    const TensorDataStridedCuda &flipCode, musaStream_t stream);
};
...
public:
     ...
     * @param stream for the asynchronous execution.
     */
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData, musaStream_t stream);
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData,
                    ...
                    const NVCVBorderType borderMode, musaStream_t stream);
};
...
public:
    ...
    ErrorCode infer(const nvcv::ImageBatchVarShape &inBatch, const nvcv::ImageBatchVarShape &outBatch,
                    ...
                    const TensorDataStridedCuda &anchors, bool noop, NVCVBorderType borderMode, musaStream_t stream);
};
...
public:
    ...
    ErrorCode infer(const ImageBatchVarShapeDataStridedCuda &inData, const TensorDataStridedCuda &outData,
                    ...
                    const NVCVBorderType borderMode, const float borderValue, musaStream_t stream);
};
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData, const double angleDeg,
                    const double2 shift, const NVCVInterpolationType interpolation, musaStream_t stream);
    /**
     * @brief calculate the cpu/gpu buffer size needed by this operator
     * @param max_input_shape maximum input DataShape that may be used
     * @param max_output_shape maximum output DataShape that may be used
...
public:
    ...
    ErrorCode infer(const nvcv::ImageBatchVarShapeDataStridedCuda &inData, const nvcv::TensorDataStridedCuda &baseData,
                    ...
                    const float epsilon, const uint32_t flags, musaStream_t stream);
};
...
public:
    ...
    ErrorCode infer(const ImageBatchVarShapeDataStridedCuda &inData, const ImageBatchVarShapeDataStridedCuda &outData,
                    const NVCVInterpolationType interpolation, musaStream_t stream);
};
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData, const int top,
                    const int left, const NVCVBorderType border_type, const float4 &borderValue, musaStream_t stream);
    /**
     * @brief calculate the cpu/gpu buffer size needed by this operator
     * @param max_input_shape maximum input DataShape that may be used
     * @param max_output_shape maximum output DataShape that may be used
...
public:
    ...
    ErrorCode infer(const ImageBatchVarShapeDataStridedCuda &inData, const ImageBatchVarShapeDataStridedCuda &outData,
                    ...
                    const NVCVBorderType border_type, const float4 value, musaStream_t stream);
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData, int crop_rows,
                    int crop_columns, musaStream_t stream);
};
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData, Size2D kernelSize,
                    double2 sigma, NVCVBorderType borderMode, musaStream_t stream);
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData,
                    ...
                    unsigned int seed, bool inplace, musaStream_t stream);
...
public:
     ...
     */
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData, Size2D kernelSize,
                    int2 kernelAnchor, NVCVBorderType borderMode, musaStream_t stream);
...
public:
    ...
    ErrorCode infer(const ImageBatchVarShapeDataStridedCuda &in, const ImageBatchVarShapeDataStridedCuda &out,
                    const TensorDataStridedCuda &ksize, musaStream_t stream);
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData, int diameter,
                    float sigmaColor, float sigmaSpace, NVCVBorderType borderMode, musaStream_t stream);
};
...
public:
    ...
    ErrorCode infer(const ImageBatchVarShapeDataStridedCuda &inData, const ImageBatchVarShapeDataStridedCuda &outData,
                    ...
                    const TensorDataStridedCuda &sigmaSpaceData, NVCVBorderType borderMode, musaStream_t stream);
};
...
private:
    nvcv::musa::osd::cuOSDContext_t m_context;
};
...
public:
    ...
    ErrorCode infer(const ImageBatchVarShapeDataStridedCuda &inData, const ImageBatchVarShapeDataStridedCuda &outData,
                    ...
                    const float4 borderValue, musaStream_t stream);
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &foreground, const TensorDataStridedCuda &background,
                    const TensorDataStridedCuda &fgMask, const TensorDataStridedCuda &outData, musaStream_t stream);
};
...
public:
    ...
    ErrorCode infer(const ImageBatchVarShapeDataStridedCuda &inData, const ImageBatchVarShapeDataStridedCuda &outData,
                    const TensorDataStridedCuda &order, musaStream_t stream);
};
...
public:
     ...
     */
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData,
                    const NVCVInterpolationType interpolation, musaStream_t stream, const Workspace &workspace);
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData,
                    const TensorDataStridedCuda &thresh, const TensorDataStridedCuda &maxval, musaStream_t stream);
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &in, const TensorDataStridedCuda &out, const double maxValue,
                    ...
                    const int32_t blockSize, const double c, musaStream_t stream);
...
public:
    ...
    ErrorCode infer(const ImageBatchVarShapeDataStridedCuda &in, const ImageBatchVarShapeDataStridedCuda &out,
                    ...
                    const TensorDataStridedCuda &c, musaStream_t stream);
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData,
                    ...
                    unsigned long long seed, musaStream_t stream);

private:
    murandState       *m_states;
...
public:
    ...
    ErrorCode infer(const TensorDataStridedCuda &inData, OptionalTensorConstRef mask,
                    const TensorDataStridedCuda &histogram, musaStream_t stream);
};
...
public:
    ...
    */
    ErrorCode infer(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &masks,
                    const TensorDataStridedCuda &outData, double inpaintRadius, musaStream_t stream);
...
public:
    ...
    */
    ErrorCode infer(const ImageBatchVarShape &inBatch, const ImageBatchVarShapeDataStridedCuda &masks,
                    const ImageBatchVarShape &outBatch, double inpaintRadius, musaStream_t stream);
