                                              ...
                                              const musa::Tensor1DWrap<float> inSigmaSpace)
{
    ...
    work_type center0 = musa::StaticCast<float>(src[coord0]);
    work_type center1 = musa::StaticCast<float>(src[coord1]);
    work_type center2 = musa::StaticCast<float>(src[coord2]);
    work_type center3 = musa::StaticCast<float>(src[coord3]);
    ...
    for (int c = colIdx - radius; c < colIdx + radius + 2; c++)
    {
        ...
        {
            int t0 = std::abs(c - colIdx), t1 = musa::abs(r - rowIdx);
            int t2 = std::abs(c - (colIdx + 1)), t3 = musa::abs(r - (rowIdx + 1));
                                         ...
                                         musaStream_t stream)
{
    ...
    typedef void (*bilateral_filter_var_shape_t)(
        ...
        const musa::Tensor1DWrap<int> &inDiameter, const musa::Tensor1DWrap<float> &inSigmaColor,
        const musa::Tensor1DWrap<float> &inSigmaSpace, musaStream_t stream);
