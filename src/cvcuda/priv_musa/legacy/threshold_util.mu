...
__global__ void triangle_cal(int *histogram, nvcv::musa::Tensor1DWrap<double, int32_t> thresh)
{
    ...
    __shared__ nvcv::legacy::musa_op::uchar idx[256];
    idx[localid]    = (nvcv::legacy::musa_op::uchar)localid;
