...
void MorphFilter2DCaller(const SrcWrapper &src, const DstWrapper &dst, NVCVMorphologyType morph_type, Size2D kernelSize,
                         int2 kernelAnchor, BT maxmin, Size2D dstSize, int numSamples, musaStream_t stream)
{
    dim3 block(16, 16);
...
nvcv::legacy::musa_op::ErrorCode MorphFilter2DCaller(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData,
                              NVCVMorphologyType morph_type, Size2D kernelSize, int2 kernelAnchor, musaStream_t stream)
{
    using BT = musa::BaseType<D>;
    ...
    {
        auto src = musa::CreateBorderWrapNHW<const D, B, int32_t>(inData, musa::SetAll<D>(val));
        auto dst = musa::CreateTensorWrapNHW<D, int32_t>(outData);
...
template<typename D>
nvcv::legacy::musa_op::ErrorCode MorphFilter2D(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData,
