...
static void cuosd_apply(cuOSDContext_t context, musaStream_t stream)
{
...
inline void RenderBlur_RGB(SrcWrap src, DstWrap dst, const musa_op::DataShape &inputShape, cuOSDContext_t context,
                           musaStream_t stream)
{
...
inline nvcv::legacy::musa_op::ErrorCode ApplyBoxBlur_RGB(const nvcv::TensorDataStridedCuda &inData, const nvcv::TensorDataStridedCuda &outData,
                                  cuOSDContext_t context, musaStream_t stream)
{
...
template<typename SrcWrap, typename DstWrap>
inline void RenderBlur_RGBA(SrcWrap src, DstWrap dst, const musa_op::DataShape &inputShape, cuOSDContext_t context,
                            musaStream_t stream)
{
    if (src.ptr(0) != dst.ptr(0))
    {
...
inline nvcv::legacy::musa_op::ErrorCode ApplyBoxBlur_RGBA(const nvcv::TensorDataStridedCuda &inData,
...
static nvcv::legacy::musa_op::ErrorCode cuosd_draw_boxblur(cuOSDContext_t context, int width, int height, NVCVBlurBoxesImpl *bboxes)
{
...
ErrorCode BoxBlur::infer(const nvcv::TensorDataStridedCuda &inData, const nvcv::TensorDataStridedCuda &outData,
                         NVCVBlurBoxesI bboxes, musaStream_t stream)
{
