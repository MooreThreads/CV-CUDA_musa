                            ...
                            musaStream_t stream)
{
    ...
    auto src = musa::CreateBorderWrapNHW<const T, B, StrideType>(inData, musa::SetAll<T>(borderValue));
    auto dst = musa::CreateTensorWrapNHW<T, StrideType>(outData);
...
nvcv::legacy::musa_op::ErrorCode BilateralFilterCaller(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData,
