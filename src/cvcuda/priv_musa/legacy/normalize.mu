...
#include <cvcuda/cuda_tools_musa/TypeTraits.hpp> // for TypeTraits
                                ...
                                float global_shift)
{
    ...
    *dst.ptr(batch_idx, src_y, src_x) = nvcv::musa::SaturateCast<input_value_type>(
                                         ...
                                         float global_scale, float global_shift, float epsilon)
{
    ...
    scale_value_type mul = 1.0f / nvcv::musa::sqrt(x);
                   ...
                   float global_scale, float shift, musaStream_t stream)
{
    ...
    auto baseWrap  = nvcv::musa::CreateTensorWrapNHW<base_type, int32_t>(baseData);
    auto scaleWrap = nvcv::musa::CreateTensorWrapNHW<scale_type, int32_t>(scaleData);
...
void callNormalizeWrap(const input_wrapper &input, const DataShape &inputShape,
                       const nvcv::TensorDataStridedCuda &baseData, const nvcv::TensorDataStridedCuda &scaleData,
                       const output_wrapper &output, float global_scale, float shift, musaStream_t stream)
{
    auto baseAccess = nvcv::TensorDataAccessStridedImagePlanar::Create(baseData);
    NVCV_ASSERT(baseAccess);
    ...
    using work_type  = nvcv::musa::ConvertBaseTypeTo<float, input_type>;
...
nvcv::legacy::musa_op::ErrorCode normalize(const nvcv::TensorDataStridedCuda &inData, const nvcv::TensorDataStridedCuda &baseData,
                    ...
                    float global_scale, float shift, musaStream_t stream)
{
    ...
    {
        auto srcWrap = nvcv::musa::CreateTensorWrapNHW<input_type, int32_t>(inData);
        auto dstWrap = nvcv::musa::CreateTensorWrapNHW<input_type, int32_t>(outData);
...
template<typename input_type>
nvcv::legacy::musa_op::ErrorCode normalizeInvStdDev(const nvcv::TensorDataStridedCuda &inData, const nvcv::TensorDataStridedCuda &baseData,
                             const nvcv::TensorDataStridedCuda &scaleData, const nvcv::TensorDataStridedCuda &outData,
                             float global_scale, float shift, float epsilon, musaStream_t stream)
{
    auto inAccess = nvcv::TensorDataAccessStridedImagePlanar::Create(inData);
