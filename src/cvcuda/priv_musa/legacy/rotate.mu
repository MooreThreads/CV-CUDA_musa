...
nvcv::legacy::musa_op::ErrorCode rotate(const TensorDataStridedCuda &inData, const TensorDataStridedCuda &outData, double *d_aCoeffs,
                 const double angleDeg, const double2 shift, musaStream_t stream)
{
    ...
    {
        auto src = musa::CreateInterpolationWrapNHW<const T, NVCV_BORDER_REPLICATE, I, int32_t>(inData);
