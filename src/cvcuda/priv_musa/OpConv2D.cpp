...
void Conv2D::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::ImageBatchVarShape &out,
                        ...
                        NVCVBorderType borderMode) const
{
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Kernel must be musa-accessible, varshape pitch-linear image batch");
    }
