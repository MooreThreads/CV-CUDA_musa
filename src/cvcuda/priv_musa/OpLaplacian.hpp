...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const int ksize,
...
private:
    std::unique_ptr<nvcv::legacy::musa_op::Laplacian>         m_legacyOp;
    std::unique_ptr<nvcv::legacy::musa_op::LaplacianVarShape> m_legacyOpVarShape;
};
