...
void RandomResizedCrop::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
void RandomResizedCrop::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
