...
void Laplacian::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, const int ksize,
...
void Laplacian::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::ImageBatchVarShape &out,
                           const nvcv::Tensor &ksize, const nvcv::Tensor &scale, NVCVBorderType borderMode) const
{
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Kernel aperture size must be musa-accessible, pitch-linear tensor");
    }
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "Kernel scale must be musa-accessible, pitch-linear tensor");
    }
