...
public:
    ...
    void operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in, const nvcv::Tensor &base,
...
private:
    std::unique_ptr<nvcv::legacy::musa_op::Normalize>         m_legacyOp;
    std::unique_ptr<nvcv::legacy::musa_op::NormalizeVarShape> m_legacyOpVarShape;
};
