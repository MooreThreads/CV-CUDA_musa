...
void BilateralFilter::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out, int diameter,
...
void BilateralFilter::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
