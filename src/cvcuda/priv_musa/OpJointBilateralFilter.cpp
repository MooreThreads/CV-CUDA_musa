...
void JointBilateralFilter::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &inColor,
                                      ...
                                      NVCVBorderType borderMode) const
{
    ...
    {
        throw nvcv::Exception(nvcv::Status::ERROR_INVALID_ARGUMENT,
                              "InputColor must be musa-accessible, pitch-linear tensor");
    }
...
void JointBilateralFilter::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
