...
void Morphology::operator()(musaStream_t stream, const nvcv::Tensor &in, const nvcv::Tensor &out,
...
void Morphology::operator()(musaStream_t stream, const nvcv::ImageBatchVarShape &in,
