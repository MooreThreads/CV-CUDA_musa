...
message(STATUS "")
if(USE_MUSA)
    message(STATUS "    MUSA Compiler : ${CMAKE_MUSA_COMPILER} (${CMAKE_MUSA_COMPILER_VERSION})")
    message(STATUS "    MUSA flags    : ${CMAKE_MUSA_FLAGS} ${CMAKE_MUSA_FLAGS_${BUILD_TYPE}}")
    message(STATUS "    MUSA toolkit target dir : ${MUSAToolkit_TARGET_DIR}")
else()
