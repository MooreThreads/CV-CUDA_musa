...
if(USE_MUSA)
    set(NVCV_TYPES_SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/src/nvcv/src)
endif()

set(_PYPROJ_CMAKE_MODULE_PATH ${CMAKE_CURRENT_BINARY_DIR}/cmake)
if(USE_MUSA)
    if(DEFINED ENV{MUSA_HOME} AND NOT "$ENV{MUSA_HOME}" STREQUAL "")
        list(APPEND _PYPROJ_CMAKE_MODULE_PATH "$ENV{MUSA_HOME}/cmake")
    endif()
    list(APPEND _PYPROJ_CMAKE_MODULE_PATH
        "/usr/local/musa/cmake"
        "/usr/local/musa-5.1.0/cmake")
endif()
string(REPLACE ";" "\\;" _PYPROJ_CMAKE_MODULE_PATH_ARG "${_PYPROJ_CMAKE_MODULE_PATH}")
...
list(APPEND PYPROJ_COMMON_ARGS
    ...
    "-DCMAKE_MODULE_PATH=${_PYPROJ_CMAKE_MODULE_PATH_ARG}"
